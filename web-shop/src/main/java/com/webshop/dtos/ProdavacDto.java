...
public class ProdavacDto {
    ...
    public ProdavacDto(String ime, String prezime, String korisnickoIme, String email, String telefon, LocalDate datumRodjenja, String profilnaSlika, String opis, Set<Proizvod> proizvodi, Set<Recenzija> dobijeneRecenzije, Double prosecnaOcena) {
        this.ime = ime;
